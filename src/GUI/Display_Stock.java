...
public class Display_Stock extends javax.swing.JFrame {
    ...
    public Display_Stock(int id,String rule) {
        initComponents();
        this.id=id;
        this.rule=rule;
        int i=0;
        if (getAllItems()!=null){
            ...
            item_list.setModel(new DefaultComboBoxModel<>(listStock));
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("/Users/hneen./IdeaProjects/caffe/icons/croissant.png")); // NOI18N
        ...
        backjButton.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
